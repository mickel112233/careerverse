        ...
        <div className="lg:w-1/3 space-y-8 -mt-24">
            <Card className="text-center p-6 pt-0">
                ...
                <p className="text-muted-foreground">Senior AI Engineer</p>
                 <p className="text-lg font-bold text-primary mt-2">Level {level}</p>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <Progress value={100} aria-label="Player Rank"/>
                    </div>
                     <div>
                        <div className="flex justify-between mb-1 text-sm">
                            <span className="font-medium">XP</span>
                            <span className="font-mono">{xpForCurrentLevel} / {xpToNextLevel}</span>
                        </div>
