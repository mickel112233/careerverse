...
const GenerateLearningRoadmapOutputSchema = z.object({
  roadmap: z.array(RoadmapNodeSchema).describe('An array of 15-20 learning levels that form the roadmap.'),
});
...
For the subject '{{{streamName}}}', create a comprehensive list of 15 learning levels. Base the content on the most popular and authoritative books, courses, and real-world skills for this field.
